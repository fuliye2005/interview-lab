...
当前分支为 `main`，`0.2.10` 发布流程修正待本轮提交；当前可用 EXE 版本为 `0.2.10`。`0.2.10` release EXE 已复制到 `D:\Interview Lab\tauri-app.exe`，文件版本为 `0.2.10`，SHA-256 为 `B5C2F418A248F5DBB17EC7C7ED84A06A36519EE45A7BA85706FDB79B8AD80BE3`。桌面已有的 `Interview Lab 0.2.8 安装包.exe/.msi` 未被覆盖，本轮没有生成安装包。普通 `main` 推送只运行 EXE job；安装包 job 只有手动触发工作流并勾选 `build_installer` 才会运行。4 张 `artifacts-window-*.png` 仅为本地诊断截图，不纳入版本库：
